...
class UserAuthScreen extends StatefulWidget {
  ...
  final ValueChanged<TasklyUser> onAuthenticated;
...
class _UserAuthScreenState extends State<UserAuthScreen> {
  AuthScreenView _currentView = AuthScreenView.welcome;
  ...
  Future<void> _handleSignup() async {
    ...
    try {
      ...
      if (res['success'] == true) {
        ...
        final successMsg = res['message'] ?? 'Account created successfully! Please sign in to continue.';
        setState(() {
          _successMessage = successMsg;
          _errorMessage = null;
          _currentView = AuthScreenView.signIn;
        });
    ...
    return Scaffold(
      body: AnimatedSwitcher(
        ...
        child: switch (_currentView) {
          AuthScreenView.welcome => _buildWelcomeScreen(),
          AuthScreenView.signIn => _buildSignInScreen(),
          AuthScreenView.signUp => _buildSignUpScreen(),
        },
      ),
    );
  }
        ...
        SafeArea(
          child: Column(
            ...
            children: [
              ...
              // Centered Title (White Taskly Logo) & Subtitle
              Padding(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                setState(() {
                                  _errorMessage = null;
                                  _currentView = AuthScreenView.signUp;
                                });
                              },
                              borderRadius: BorderRadius.circular(28),
                              child: const Center(
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () {
          setState(() {
            _errorMessage = null;
            _currentView = AuthScreenView.welcome;
          });
        },
