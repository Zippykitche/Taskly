...
**Reviews**
- `POST /reviews/` - Create a review for a completed task (requires JWT auth)
- `GET /reviews/` - List all reviews
- `GET /reviews/task/{task_id}` - Get all reviews for a task
...
Install the project dependencies and run the included test suite:
...
2. Authenticated current user retrieval
3. Task creation and lifecycle (create, list, claim, complete)
4. Review creation and task review retrieval
